    ...
    return (
        <div className="max-w-container mx-auto mt-16 lg:px-5 px-5">
            <div className="text-center mb-16">
                <h2 className="text-[#5E5E5E] text-[40px] font-normal">Admin Dashboard</h2>
            </div>
            <div className="grid lg:grid-cols-4 md:grid-cols-4 grid-cols-2 gap-10">
                <div className="text-[#5E5E5E] rounded-[20px] bg-[#fff] shadow-md shadow-slate-500 flex flex-col justify-center items-center text-center p-5">
